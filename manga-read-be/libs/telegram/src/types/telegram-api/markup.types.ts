import { ChatAdministratorRights } from './chat.types';
...
interface InlineUrlButton extends AbstractInlineKeyboardButton {
  /** HTTP or tg:// URL to be opened when the button is pressed. Links tg://user?id=<user_id> can be used to mention a user by their identifier without using a username, if this is allowed by their privacy settings. */
  url: string;
}

interface InlineCallbackButton extends AbstractInlineKeyboardButton {
  /** Data to be sent in a callback query to the bot when the button is pressed, 1-64 bytes */
  callback_data: string;
}

export interface InlineWebAppButton extends AbstractInlineKeyboardButton {
  /** Description of the Web App that will be launched when the user presses the button. The Web App will be able to send an arbitrary message on behalf of the user using the method answerWebAppQuery. Available only in private chats between a user and the bot. Not supported for messages sent on behalf of a Telegram Business account. */
  web_app: WebAppInfo;
}

export interface InlineLoginButton extends AbstractInlineKeyboardButton {
  /** An HTTPS URL used to automatically authorize the user. Can be used as a replacement for the Telegram Login Widget. */
  login_url: LoginUrl;
}

export interface InlineSwitchInlineButton extends AbstractInlineKeyboardButton {
  /** If set, pressing the button will prompt the user to select one of their chats, open that chat and insert the bot's username and the specified inline query in the input field. May be empty, in which case just the bot's username will be inserted. Not supported for messages sent on behalf of a Telegram Business account. */
  switch_inline_query: string;
}

export interface InlineSwitchInlineCurrentChatButton extends AbstractInlineKeyboardButton {
...
export interface InlineSwitchInlineChosenChatButton extends AbstractInlineKeyboardButton {
...
export interface InlineGameButton extends AbstractInlineKeyboardButton {
  /** Description of the game that will be launched when the user presses the button.
   NOTE: This type of button must always be the first button in the first row. */
  callback_game: CallbackGame;
}

export interface InlinePayButton extends AbstractInlineKeyboardButton {
...
export type InlineKeyboardButton =
  ...
  | InlineLoginButton
  | InlinePayButton
  | InlineSwitchInlineButton
  | InlineSwitchInlineCurrentChatButton
  | InlineSwitchInlineChosenChatButton
  | InlineUrlButton
  | WebAppButton;
