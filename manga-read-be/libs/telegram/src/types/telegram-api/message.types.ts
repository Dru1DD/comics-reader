import { ChannelChat, Chat } from './chat.types';
import { User } from './user.types';
import { InlineKeyboardMarkup } from './markup.types';
import { PassportData } from './passport.types';
import { Invoice, RefundedPayment, SuccessfulPayment } from './payment.types';
import { PhotoSize } from './photo.types';
import { PaidMediaInfo } from './media.types';
import { ReactionCount, ReactionType } from './reaction.types';
...
export type RefundedPaymentMessage = ServiceMessage & MsgWith<'refunded_payment'>;
...
export type ChatBackgroundSetMessage = ServiceMessage & MsgWith<'chat_background_set'>;
...
export type GiveawayCreatedMessage = ServiceMessage & MsgWith<'giveaway_created'>;
export type GiveawayMessage = ServiceMessage & MsgWith<'giveaway'>;
export type GiveawayWinnersMessage = ServiceMessage & MsgWith<'giveaway_winners'>;
export type GiveawayCompletedMessage = ServiceMessage & MsgWith<'giveaway_completed'>;
...
export interface Message extends MediaMessage {
