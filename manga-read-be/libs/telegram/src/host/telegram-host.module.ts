...
import { NestProviderValueFactory } from '../../../types';
...
export interface RootAsyncTelegramHostModuleOptions
  extends Pick<ModuleMetadata, 'imports'> {
  useConfigFactory: NestProviderValueFactory<
...
export class TelegramHostModule {
  ...
  public static forRootAsync(
    options: RootAsyncTelegramHostModuleOptions,
  ): DynamicModule {
    return {
