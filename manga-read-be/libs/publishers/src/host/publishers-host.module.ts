...
export interface PublishersHostModuleOptions
...
export class PublishersHostModule {
  public static getMessagePublisherServiceToken =
    getMessagePublisherServiceToken;
  ...
  static forRoot(options: PublishersHostModuleOptions): DynamicModule {
    const { providers, exports } = (options.publisherNames || []).reduce(
      (aggregation, publisherName) => {
        ...
        aggregation.exports.push(
          getMessagePublisherServiceToken(publisherName),
        );
    ...
    return {
      ...
      exports: options.publisherNames
        ? exports
        : [getMessagePublisherServiceToken()],
    };
  }
